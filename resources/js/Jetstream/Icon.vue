<template>
    ...
    <div v-else-if="name === 'home-icon'" class="w-6 transform hover:text-gray-500 hover:scale-110 relative flex flex-col items-center group whitespace-nowrap">
    ...
    <div v-else-if="name === 'users-icon'" class="w-6 transform hover:text-gray-500 hover:scale-110 relative flex flex-col items-center group whitespace-nowrap">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div v-else-if="name === 'parameters-icon'" class="w-6 transform hover:text-gray-500 hover:scale-110 relative flex flex-col items-center group whitespace-nowrap">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div v-else-if="name === 'playbook-icon'" class="w-6 transform hover:text-gray-500 hover:scale-110 relative flex flex-col items-center group whitespace-nowrap">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div v-else-if="name === 'application-icon'" class="w-6 transform hover:text-gray-500 hover:scale-110 relative flex flex-col items-center group whitespace-nowrap">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div v-else-if="name === 'gig-ad-icon'" class="w-6 transform hover:text-gray-500 hover:scale-110 relative flex flex-col items-center group whitespace-nowrap">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div v-else-if="name === 'find-gig-icon'" class="w-6 transform hover:text-gray-500 hover:scale-110 relative flex flex-col items-center group whitespace-nowrap">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <svg v-else-if="name === 'like-icon-sm'" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905 0 .714-.211 1.412-.608 2.006L7 11v9m7-10h-2M7 20H5a2 2 0 01-2-2v-6a2 2 0 012-2h2.5" />
    </svg>

    <svg v-else-if="name === 'chat-icon'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
    </svg>

    <svg v-else-if="name === 'share-icon'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
    </svg>

    <svg v-else-if="name === 'search-icon'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
    </svg>

    <svg v-else-if="name === 'clear-icon'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div v-else-if="name === 'applicant-icon'" class="w-4 mr-2 transform hover:text-indigo-500 hover:scale-110 relative flex flex-col items-center group">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div v-else-if="name === 'interview-icon'" class="w-4 mr-2 transform hover:text-indigo-500 hover:scale-110 relative flex flex-col items-center group">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div v-else-if="name === 'contract-icon'" class="w-4 mr-2 transform hover:text-green-500 hover:scale-110 relative flex flex-col items-center group">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div v-else-if="name === 'task-list-icon'" class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110 relative flex flex-col items-center group">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
